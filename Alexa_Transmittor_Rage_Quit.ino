...
#define MySSID "wifi here" // TODO: Change to your Wifi network SSID
#define MyWifiPassword "pass here" // TODO: Change to your Wifi network password
...
void turnOn(String deviceId) {
  ...
  if (deviceId == "device id here") // //Rage Quit
  {
  ...
  if (deviceId == "device id here") //QUIT
  {
...
void turnOff(String deviceId) {
  ...
  if (deviceId == "device id here") // shooting
  {
